...
brands_map <- function(var, color, legend.title) {
  ...
  # add a legend
  legend.text <- c(paste0(round(p1, 0), " or less brands purchased (20th Percentile)"),
                   paste0(round(p1, 0), " - ", round(p2, 0), " brands purchased (40th Percentile)" ),
                   paste0(round(p2, 0), " - ", round(p3, 0), " brands purchased (60th Percentile)"),
                   paste0(round(p3, 0), " - ", round(p4, 0), " brands purchased (80th Percentile)"),
                   paste0(round(p4, 0), " or more brands purchased"))
